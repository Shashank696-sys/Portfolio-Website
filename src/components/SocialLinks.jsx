...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/shashank-pandey-159431324/?trk=public_profile-settings_edit-profile-content&originalSubdomain=in",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@Shashank_0001_",
    icon: Instagram,
    url: "https://www.instagram.com/shashank__0001__/",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@Shashank_0001_",
    icon: Github,
    url: "https://github.com/Shashank696-sys",
    color: "#ffffff",
  ...
  },
  {
    ...
    subText: "+91 8115067311",
    icon: ({ className, ...props }) => (
      <img
        src="/phone1.png" // Make sure this path matches where the image is hosted in your project
        alt="Phone Icon"
